...
const BillboardForm: React.FC<BillboardFormProps> = ({
    ...
    const onSubmit = async (values: BillboardFormValues) => {
        ...
        try {
            if(initialData){
                await apiPatch(`/${params?.storeId}/billboards/${params.billboardId}`,values);
            } else {
                await apiPost(`/${params?.storeId}/billboards`,values);
            }
            router.refresh();
    ...
    const onDelete = async () => {
        setLoading(true);
        try {
            await apiDelete(`/${params?.storeId}/billboards/${params.billboardId}`);
            router.refresh();
            router.push(`/${params.storeId}/billboards`);
